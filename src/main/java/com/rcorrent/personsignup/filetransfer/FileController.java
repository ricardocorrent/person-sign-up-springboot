...
public class FileController {
    ...
    public UploadFileResponseVO uploadFile(@RequestParam("file") final MultipartFile file) {
    ...
    public List<UploadFileResponseVO> uploadMultipleFiles(@RequestParam("files") final MultipartFile[] files) {
